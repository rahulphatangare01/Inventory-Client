    ...
    return (
        <Grid>
            <Paper elevation={10} style={papreStyle}>
                ...
                <TextField id="standard-basic" label="Name" variant="standard" fullWidth  name='name' onChange={handleChange}/>

                <TextField id="standard-basic"  type="email" label="Email" variant="standard" fullWidth  name='email' onChange={handleChange}/>
                <TextField
                    id="standard-password-input"
                    label="PhoneNumber"
                    type="Tel"
                    variant="standard"
                    fullWidth  name='phone' onChange={handleChange} />
